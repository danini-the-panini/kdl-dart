...
main() {
  ...
  test('ci', () async {
    var string = await new File('examples/ci.kdl').readAsString();
  ...
  test('cargo', () async {
    var string = await new File('examples/cargo.kdl').readAsString();
    var doc = Kdl.parseDocument(string);
    var expectedDoc = nodes(() {
      _("package", () {
        _("name", "kdl");
  ...
  test('nuget', () async {
    var string = await new File('examples/nuget.kdl').readAsString();
    var doc = Kdl.parseDocument(string);
